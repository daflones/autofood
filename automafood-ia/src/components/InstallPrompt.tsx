...
export default function InstallPrompt() {
  ...
  return (
    <div className="fixed left-1/2 -translate-x-1/2 bottom-4 z-[9999] w-[calc(100%-1.5rem)] sm:w-auto max-w-md">
      <div className="af-card-elev ring-1 ring-gray-200/70 px-4 py-3 rounded-xl shadow-lg bg-white/95 backdrop-blur">
        {isIOS && !isStandalone ? (
          <div className="text-sm leading-relaxed">
            <div className="font-semibold mb-1">Instale o app</div>
            <div className="af-text-dim">Abra no Safari e toque em <span className="font-semibold">Compartilhar</span> (ícone de seta) e depois em <span className="font-semibold">Adicionar à Tela de Início</span>.</div>
          ...
          <div className="text-sm leading-relaxed">
            <div className="font-semibold mb-1">Instale o app</div>
            <div className="af-text-dim">Adicione o AutomaFood à tela inicial para uma experiência completa.</div>
            <div className="mt-2 flex justify-end gap-2">
              <button className="af-btn-ghost px-3 py-1.5 text-sm" onClick={() => { markShownNow(); setVisible(false) }}>Agora não</button>
